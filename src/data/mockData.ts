...
export const mockExercises: Exercise[] = [
  ...
  { id: 'ex-2', name: 'Ab Wheel Rollout', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Other' },
  { id: 'ex-3', name: 'Arnold Press', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Dumbbell' },
  ...
  { id: 'ex-6', name: 'Back Squat', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-16', name: 'Barbell Row', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-17', name: 'Barbell Shrugs', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-22', name: 'Barbell Wrist Curl', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-25', name: 'Behind-the-back Curl', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-26', name: 'Bench Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-27', name: 'Bent Over Barbell Rear Delt Raise', muscleGroup: 'Rear Delts', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-28', name: 'Bicep Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-29', name: 'Boxing', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Other' },
  { id: 'ex-30', name: 'Bulgarian Split Squat', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-31', name: 'Cable Bicep Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-32', name: 'Cable Crossover', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-33', name: 'Cable Crunch', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-34', name: 'Cable Face Pull', muscleGroup: 'Rear Delts', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-35', name: 'Cable Fly', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-36', name: 'Cable Lat Pulldown', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-37', name: 'Cable Lateral Raise', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-38', name: 'Cable Leg Sidekick', muscleGroup: 'Glutes', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-39', name: 'Cable Pushdown', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Cables' },
  ...
  { id: 'ex-47', name: 'Calf Raises', muscleGroup: 'Calves', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-50', name: 'Chest Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-51', name: 'Chin-Up', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-52', name: 'Chin-ups', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-53', name: 'Close-grip Bench Press', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-54', name: 'Close-grip LAT Pulldown', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-55', name: 'Concentration Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-56', name: 'Cross Body Cable Triceps Extension', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-57', name: 'Deadlift', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-58', name: 'Decline Ab Crunch', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Other' },
  { id: 'ex-59', name: 'Decline Bench Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-63', name: 'Diamond Push-ups', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-64', name: 'Dips', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Bodyweight' },
  ...
  { id: 'ex-70', name: 'Dumbbell Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Dumbbell' },
  ...
  { id: 'ex-73', name: 'Dumbbell Row', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-74', name: 'Dumbbell Shoulder Press', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Dumbbell' },
  ...
  { id: 'ex-77', name: 'Dumbbell Wrist Curl', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-78', name: 'Egyptian Lateral Raise', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Other' },
  { id: 'ex-79', name: 'EZ Bar Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-80', name: 'Face Pull', muscleGroup: 'Rear Delts', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-81', name: 'Farmer Walk With Fat Grip', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Other' },
  { id: 'ex-82', name: 'Front Squat', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-83', name: 'Glute Hyperextension', muscleGroup: 'Glutes', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-84', name: 'Glute Kickback', muscleGroup: 'Glutes', allTimeSets: 0, equipment: 'Cables' },
  { id: 'ex-85', name: 'Goblet Squat', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-86', name: 'Hack Squat', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-87', name: 'Hammer Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-88', name: 'Hammer Strength Row', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-89', name: 'Hanging Leg Raise', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Bodyweight' },
  ...
  { id: 'ex-94', name: 'Hip Thrust', muscleGroup: 'Glutes', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-95', name: 'Hyperextensions', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-96', name: 'Incline Barbell Bench Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-97', name: 'Incline Bench Press', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-101', name: 'Incline Dumbbell Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-102', name: 'Incline Dumbbell Fly', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Dumbbell' },
  ...
  { id: 'ex-108', name: 'LAT Pulldown', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Cables' },
  ...
  { id: 'ex-112', name: 'Lateral Raise', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-113', name: 'Leg Curl', muscleGroup: 'Hamstrings', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-114', name: 'Leg Extension', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-115', name: 'Leg Press', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-119', name: 'Lying Leg Curl', muscleGroup: 'Hamstrings', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-126', name: 'Nordic Curl', muscleGroup: 'Hamstrings', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-127', name: 'Overhead Press', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-128', name: 'Overhead Tricep Ext', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-129', name: 'Pec Dec Fly', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-132', name: 'Plank', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Bodyweight' },
  ...
  { id: 'ex-136', name: 'Preacher Curl', muscleGroup: 'Biceps', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-137', name: 'Pull-Up', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-138', name: 'Pull-ups', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-139', name: 'Push-ups', muscleGroup: 'Chest', allTimeSets: 0, equipment: 'Bodyweight' },
  { id: 'ex-140', name: 'Rear Delt Fly', muscleGroup: 'Rear Delts', allTimeSets: 0, equipment: 'Dumbbell' },
  { id: 'ex-141', name: 'Rear Delt Fly Machine', muscleGroup: 'Shoulders', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-142', name: 'Reverse Barbell Curl', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-145', name: 'Reverse Pec Dec Fly', muscleGroup: 'Rear Delts', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-148', name: 'Romanian Deadlift', muscleGroup: 'Hamstrings', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-149', name: 'Russian Twist', muscleGroup: 'Core', allTimeSets: 0, equipment: 'Bodyweight' },
  ...
  { id: 'ex-152', name: 'Seated Calf Raise', muscleGroup: 'Calves', allTimeSets: 0, equipment: 'Machine' },
  ...
  { id: 'ex-157', name: 'Seated Leg Curl', muscleGroup: 'Hamstrings', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-158', name: 'Seated Leg Press', muscleGroup: 'Quads', allTimeSets: 0, equipment: 'Machine' },
  { id: 'ex-159', name: 'Seated Row', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Cables' },
  ...
  { id: 'ex-173', name: 'Skull Crushers', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-180', name: 'Sumo Deadlift', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Barbell' },
  { id: 'ex-181', name: 'T-bar Row', muscleGroup: 'Back', allTimeSets: 0, equipment: 'Barbell' },
  ...
  { id: 'ex-187', name: 'Tricep Dips', muscleGroup: 'Triceps', allTimeSets: 0, equipment: 'Bodyweight' },
  ...
  { id: 'ex-195', name: 'Wrist Roller', muscleGroup: 'Forearms', allTimeSets: 0, equipment: 'Other' },
];
