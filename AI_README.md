...
├── assets/                  # Fonts, static assets, and splash screens
├── data/
...
### ⚠️ Expo Version Compliance
- **Expo SDK 56** is in use. Refer strictly to `https://docs.expo.dev/versions/v56.0.0/` for documentation.
- Do **NOT** use deprecated React Native or Expo packages. Use recommended modern practices (e.g. standard vector icons via `@react-native/vector-icons`).
