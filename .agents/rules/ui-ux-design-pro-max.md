...
Rules:
- **Design Alignment:** When building, modifying, or reviewing any UI component or screen, first read the project's [UI_UX_README.md](file:///f:/Antigravity/strongerN/UI_UX_README.md) and [design-system/strongern/MASTER.md](file:///f:/Antigravity/strongerN/design-system/strongern/MASTER.md) to ensure perfect aesthetic synchronization.
...
- **Pre-Delivery Verification:** Before delivering any front-end code, verify each screen against the **UI/UX Pro Max Quality Checklist** located in [UI_UX_README.md](file:///f:/Antigravity/strongerN/UI_UX_README.md#7-uiux-pro-max-quality-checklist).
